...
const viteDocsPlugin = () => {
    ...
    return {
        ...
        async load(id) {
            ...
            code.push(`const fileImports = {`, ...Object.entries(globbedDocuments).map(([routePath, importPath]) => `  "${routePath}": () => import("${importPath}"),`), `};`, `export const configuredDocsPlugin = markdownPlugin({`, `  fileImports,`, `  defaultOptions: ${JSON.stringify(docsConfig.defaultOptions)},`, `});`);
