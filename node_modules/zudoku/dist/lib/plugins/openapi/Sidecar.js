...
export const Sidecar = ({ operation, selectedResponse, onSelectResponse, }) => {
    ...
    const code = useMemo(() => {
        const exampleBody = selectedExample ??
