...
export const OperationList = ({ tag, untagged, }) => {
    ...
    const paginationProps = {
        ...
        next: next
            ? {
                ...
                label: next.extensions?.["x-displayName"] ??
                    next.name ??
                    "Other endpoints",
            }
            : undefined,
    ...
    return (_jsxs("div", { className: "pt-(--padding-content-top)", "data-pagefind-filter": "section:openapi", "data-pagefind-meta": "section:openapi", children: [_jsxs(Helmet, { children: [helmetTitle && _jsx("title", { children: helmetTitle }), metaDescription && (_jsx("meta", { name: "description", content: metaDescription }))] }), _jsxs("div", { className: "mb-8", children: [_jsxs(Collapsible, { className: "w-full", defaultOpen: options?.expandApiInformation, children: [_jsxs("div", { className: "flex flex-col gap-y-4 sm:flex-row justify-around items-start sm:items-end", children: [_jsxs("div", { className: "flex flex-col flex-1 gap-2", children: [_jsx(CategoryHeading, { children: title }), _jsxs(Heading, { level: 1, id: "description", registerNavigationAnchor: true, className: "mb-0", children: [tagTitle, showVersions && (_jsxs("span", { className: "text-xl text-muted-foreground ms-1.5", children: [" ", "(", version, ")"] }))] }), _jsx(Endpoint, {})] }), _jsxs("div", { className: "flex flex-col gap-4 sm:items-end", children: [showVersions && (_jsxs(Select
