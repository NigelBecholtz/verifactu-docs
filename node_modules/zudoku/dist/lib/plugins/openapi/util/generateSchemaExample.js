...
export const generateSchemaExample = (schema, name) => {
    ...
    if (schema.oneOf) {
        ...
        return generateSchemaExample(schema.oneOf[randomIndex]);
    }
    if (schema.anyOf) {
        ...
        return generateSchemaExample(schema.anyOf[randomIndex]);
    }
    if (schema.allOf) {
        ...
        return schema.allOf.reduce((acc, allOfSchema) => {
            return { ...acc, ...generateSchemaExample(allOfSchema) };
        }, {});
    }
    switch (schema.type) {
        case "string":
