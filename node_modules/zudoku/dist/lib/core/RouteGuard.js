...
export const RouteGuard = () => {
    ...
    const authCheckFn = !shouldBypass && protectedRoutes
        ? Object.entries(protectedRoutes).find(([path]) => matchPath({ path, end: true }, location.pathname))?.[1]
        : undefined;
    const isProtectedRoute = authCheckFn !== undefined;
    const needsToSignIn = isProtectedRoute && !authCheckFn({ auth, context: zudoku });
    useQuery({
