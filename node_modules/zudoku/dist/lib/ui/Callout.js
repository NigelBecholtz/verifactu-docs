...
export const Callout = ({ type, children, title, className, icon = true, }) => {
    ...
    return (_jsxs("div", { className: cn("not-prose rounded-md border p-4 text-md my-2", icon &&
            "grid grid-cols-[min-content_1fr] items-baseline grid-rows-[fit-content_1fr] gap-x-4 gap-y-2", !icon && title && "flex flex-col gap-2", "[&_a]:underline [&_a]:decoration-current [&_a]:decoration-from-font [&_a]:underline-offset-4 hover:[&_a]:decoration-1", "[&_.code-block-wrapper]:border", "[&_ul]:list-disc [&_ol]:list-decimal [&_ul]:ps-4 [&_ul>li]:ps-1 [&_ul>li]:my-1", icon && title && "items-center", border, bg, className), children: [icon && (_jsx(Icon, { className: cn(!title ? "translate-y-1" : "align-middle", iconColor), size: 20, "aria-hidden": "true" })), title && _jsx("h3", { className: cn("font-medium", titleColor), children: title }), _jsx("div", { className: cn(icon && "col-start-2", !title && icon && "row-start-1", textColor, "overflow-x-auto"), children: children })] }));
};
