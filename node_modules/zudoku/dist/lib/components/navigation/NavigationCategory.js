...
const NavigationCategoryInner = ({ category, onRequestClose, }) => {
    ...
    const ToggleButton = isCollapsible && (_jsx(Button, { onClick: (e) => {
        ...
        }, variant: "ghost", size: "icon", className: "size-6 hover:bg-[hsl(from_var(--accent)_h_s_calc(l+6*var(--dark)))]", children: _jsx(ChevronRightIcon, { size: 16, className: cn(hasInteracted && "transition", "shrink-0 group-data-[state=open]:rotate-90 rtl:rotate-180") }) }));
    ...
    return (_jsxs(Collapsible.Root, { className: "flex flex-col", defaultOpen: isDefaultOpen, open: open, onOpenChange: () => setOpen(true), children: [_jsx(Collapsible.Trigger, { className: "group", asChild: true, disabled: !isCollapsible, children: category.link?.type === "doc" ? (_jsxs(NavLink, { to: {
                    ...
                    }, children: [icon, _jsxs("div", { className: "flex items-center gap-2 justify-between w-full text-foreground/80 group-aria-[current='page']:text-primary", children: [_jsx("div", { className: "truncate", children: category.label }), ToggleButton] })] })) : (
                // biome-ignore lint/a11y/noStaticElementInteractions: This is only to track if the user has interacted
                _jsxs("div", { onClick: () => setHasInteracted(true), onKeyUp: (e) => {
                        if (e.key === "Enter" || e.key === " ")
                            setHasInteracted(true);
                    }, className: styles, children: [icon, _jsxs("div", { className: "flex items-center justify-between w-full", children: [_jsx("div", { className: "flex gap-2 truncate w-full", children: category.label }), ToggleButton] })] })) }), _jsx(Collapsible.Content, { className: cn(
