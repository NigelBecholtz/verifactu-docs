...
export const Footer = () => {
    ...
    return (_jsx("footer", { className: "border-t bg-background", children: _jsxs("div", { className: "mx-auto max-w-screen-2xl px-4 lg:px-8 py-8 pt-20", children: [_jsxs("div", { className: cn("flex flex-row gap-8", {
                    ...
                    }), children: [_jsx(Slot.Target, { name: "footer-before" }), footer.columns && (_jsx("div", { className: "w-full md:max-w-screen-md grid grid-cols-[1fr_1fr] gap-8 md:grid-cols-[repeat(var(--columns),minmax(0,1fr))]", style: { "--columns": footer.columns.length }, children: footer.columns.map((column) => (_jsxs("div", { className: cn({
